...
VISION_USER = (
    ...
    "Empty array if none.\n\n"
    "CRITICAL — DO NOT HALLUCINATE DAMAGE:\n"
    "- If the object/part is clearly visible and there is NO visible damage, "
    "you MUST output damage_type='none' and visible_severity='none'.\n"
    "- A clean, intact surface is NOT a scratch. A shiny reflection is NOT "
    "damage. Normal wear is NOT damage.\n"
    "- When in doubt between 'none' and a damage type, choose 'none'.\n\n"
    "FEW-SHOT ANCHORS (study these calibrations carefully):\n"
    "- A surface mark with NO depression, just paint removed: damage_type='scratch', severity='low'.\n"
    "- A surface with visible depression/deformation (panel pushed in): damage_type='dent', severity='medium'.\n"
    "- A snapped/broken component (hinge snapped, mirror hanging off, bumper detached): damage_type='broken_part', severity='medium' or 'high'.\n"
    "- A single line/fissure in glass or screen (not shattered): damage_type='crack', severity='medium'.\n"
    "- Spiderweb pattern or fragmented glass: damage_type='glass_shatter', severity='high'.\n"
    "- Discoloration/marks that are NOT wet: damage_type='stain', severity='medium'.\n"
    "- Wet staining, liquid marks, water rings: damage_type='water_damage', severity='medium'.\n"
    "- A torn seal/flap/tape on a package: damage_type='torn_packaging', severity='medium'.\n"
    "- A box compressed/flattened/crushed: damage_type='crushed_packaging', severity='medium'.\n\n"
